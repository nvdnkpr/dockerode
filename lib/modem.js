...
Modem.prototype.dial = function(options, callback) {
  ...
  req.on('response', function(res) {
    ...
    if (options.isStream) {
      ...
      self.buildPayload(null, options.isStream, options.statusCodes, dup, null, callback);
    } else {
      var chunks = '';
      ...
      res.on('end', function() {
        ...
        self.buildPayload(null, options.isStream, options.statusCodes, dup, json, callback);
      });
    }
  });
